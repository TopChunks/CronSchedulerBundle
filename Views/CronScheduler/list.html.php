                    ...
                    <tr>
                        ...
                        <td class="visible-md visible-lg">
                            ...
                            <span style="white-space: nowrap;"><span class="label label-default pa-4"
                                    style="border: 1px solid #d5d5d5; background: <?php echo $color; ?>;"> </span>
                        ...
                        <td class="visible-md visible-lg"><?php echo $item->getPriority(); ?></td>
